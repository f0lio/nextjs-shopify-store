      ...
      <Popover>
        <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
          <div className="md:flex md:justify-center ">
            <nav
              className="relative flex items-center justify-between sm:h-10 max-w-7xl w-full"
              aria-label="Global"
            >
              ...
              <div className="hidden md:flex md:ml-10 md:pr-4 justify-center md:space-x-8">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
